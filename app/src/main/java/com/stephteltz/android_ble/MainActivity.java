...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.stephteltz.android_ble.R.layout.activity_main);
    ...
    private void init() {
        ...
        spinner = (ProgressBar) findViewById(com.stephteltz.android_ble.R.id.spinner);
        spinner.setVisibility(4); // By default spinner is invisible
        textView = (TextView) findViewById(com.stephteltz.android_ble.R.id.text_view);
        textView.setText("Click 'Start Scan' to search for devices.");
        buttonScanStart = (Button) findViewById(com.stephteltz.android_ble.R.id.bt_scan_start);
